  ...
  return (
    <div className="min-h-[60vh] pt-32 px-8">
      ...
      <p className="font-light text-center max-w-[68ch] mx-auto text-balance mb-8">
        Please click the button below to return to our main services page. If
        you&#39;re unsure which service you need please don&#39;t hesitate to
