...
export const faQuestions: Faq[] = [
  {
    id: 1,
    question: "Do you offer emergency drainage callouts?",
    answer:
      "Yes. We provide rapid response drainage support for urgent issues such as blocked drains, overflows and backups. If you're dealing with a drainage emergency, contact our team and we'll respond as quickly as possible.",
    category: "main",
  },
  {
    id: 2,
    ...
    answer:
      "We operate across Norfolk, Suffolk and Cambridgeshire, covering towns, villages and surrounding areas. If you're unsure whether we cover your location, just get in touch and we'll confirm availability.",
    category: "main",
  },
  {
    id: 3,
    ...
    answer:
      "Yes. We provide drainage services for homeowners, landlords, letting agents and commercial clients, including shops, offices, hospitality venues and industrial sites.",
    category: "main",
  },
  {
    id: 4,
    question: "Are your drainage engineers qualified and insured?",
    answer:
      "Yes. Our engineers are fully trained, experienced and insured, using professional equipment to carry out all work safely and effectively.",
    category: "main",
  },
  {
    id: 5,
    question: "How do I book a drainage service?",
    answer:
      "You can call us directly, email our team or complete the contact form on our website. We'll discuss the issue, confirm availability and arrange a visit.",
    category: "main",
  },
  {
    id: 6,
