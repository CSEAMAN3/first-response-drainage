...
export default function Reviews({ reviewsData }: ReviewsProps) {
  ...
  return (
    <section className="pt-8 pb-16 px-8 max-w-280 mx-auto">
      <h2 className="text-center font-light mb-8 text-balance tracking-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4">
        <div className="place-content-center">
          <h3 className="font-bold text-fr-primary text-xl text-balance max-w-[40ch] mb-2 tracking-tight">
          ...
          <Link
            ...
            className="font-bold text-fr-primary hover:text-fr-accent-one transition-colors duration-300 tracking-tight"
          >
