...
export default function Faq() {
  return (
    <section className="py-8 md:py-16">
      <div className="px-8">
        <h2 className="text-center font-bold text-xl md:text-2xl text-fr-light-purple">
        ...
        <Link
          href="/faq"
          className="font-bold bg-fr-red text-fr-white hover:bg-fr-dark-red px-8 py-4 mt-16 block mx-auto w-fit rounded-sm"
        >
          View More FAQs
        </Link>
      </div>
