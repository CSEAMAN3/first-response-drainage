...
export default function MainServiceCard({
  ...
  return (
    <Link
      ...
      className="bg-fr-light-grey hover:bg-fr-accent-two-light block p-8 border-b-4 border-fr-red hover:border-fr-primary mx-auto transition-all duration-500 group shadow-xl hover:shadow-2xl transform hover:-translate-y-3"
    >
