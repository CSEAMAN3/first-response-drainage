...
export default function HeaderNav() {
  ...
  return (
    <div>
      ...
      <Link
        href="/contact"
        className="hidden lg:block absolute top-5 right-8 bg-fr-red hover:bg-fr-accent-one-dark text-fr-white font-bold rounded-sm px-8 py-4 transition-all duration-400"
      >
        Request Callout
      </Link>
    </div>
