      ...
      <div className="flex flex-col lg:flex-row max-w-300 mx-auto gap-16 px-8 pt-16 pb-8">
        <div className="lg:flex-1 z-10">
          ...
          <div className="flex gap-8 place-content-center mb-8">
            <Link
              href="/contact"
              className="text-fr-white bg-fr-accent-one px-8 py-4 rounded-sm block mb-6 font-bold hover:bg-fr-accent-one-mid transition-colors duration-300 cursor-pointer w-full max-w-60 text-center"
            >
              Request a Callout
            </Link>
            <a
              ...
              className="text-fr-white border-2 border-fr-accent-two px-8 py-4 rounded-sm block mb-6 font-bold hover:bg-fr-primary-dark transition-colors duration-300 cursor-pointer w-full text-center max-w-60"
            >
              Call Now
            </a>
          </div>
          <Link
            href={"#coverage"}
            className="block text-center font-bold text-fr-white hover:text-fr-accent-two mb-8 lg:text-start transition-colors duration-300"
          >
            CHECK COVERAGE IN YOUR AREA{" "}
            <FaArrowRight className="inline-block mb-1" />
          </Link>
