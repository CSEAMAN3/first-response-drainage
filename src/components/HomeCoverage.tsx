...
export default function HomeCoverage() {
  return (
    <section className="grid grid-cols-2 relative">
      <div className="bg-fr-dark-blue min-h-75 md:h-125" />
      <div className="bg-fr-white min-h-75 md:h-125" />
      <div className="min-h-75 absolute top-0 left-1/2 -translate-x-1/2 w-screen max-w-300 bg-fr-white grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="order-2 md:order-1">
          ...
          <img
            ...
            alt="map"
            className="max-h-150 md:max-h-125 w-auto"
          />
        </div>
        {/* content div */}
        <div className="order-1 md:order-2 px-8 py-8 place-content-center">
          <h3 className="font-bold text-3xl text-balance mb-4 text-fr-mid-blue">
